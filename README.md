...
In the database folder, you'll find the scripts to create the tables (and populate with data) and setup security for the java server to use. Create a database called tenmo using pgAdmin. Then run schema.sql followed by user.sql in the tenmo database.
